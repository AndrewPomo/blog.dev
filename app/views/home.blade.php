...
<div id='home-hero' class="container">
    <div id='home-jumbo' class="jumbotron">
        ...
        <div id="links" class="text-center">
        	...
        	<a class="col-xs-6 col-md-4" href={{{'mailto:andrewpomo815@gmail.com'}}}><i class="fa fa-envelope-square fa-4" aria-hidden="true"></i></a>
        	<a class="col-xs-6 col-md-4" href="https://www.linkedin.com/in/andrewpomo"><i class="fa fa-linkedin-square fa-4" aria-hidden="true"></i></a>
        	<a class="col-xs-6 col-md-4" href="https://github.com/AndrewPomo"><i class="fa fa-github fa-4" aria-hidden="true"></i></a>
        	<a class="col-xs-6 col-md-4" href="https://angel.co/andrew-powell-morse"><i class="fa fa-angellist fa-4" aria-hidden="true"></i></a>
        </div>
        <p></p>
    </div>
</div>
